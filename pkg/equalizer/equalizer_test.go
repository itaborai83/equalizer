...
// A - Source: filled, Target: filled
// B - Source: row, Target: row
func TestEqualizeFilledRowSourceFilledRowTarget(t *testing.T) {
	sourcePayload := `[
		{ "id": 1, "name": "Alice", "updated_at": "2020-01-01" },
		{ "id": 2, "name": "Bob", "updated_at": "2020-01-03" },
		{ "id": 3, "name": "Charlie", "updated_at": "2020-01-03" }
	]`
	sourceData := parseJsonOrPanic(sourcePayload)
	targetPayload := `[
...
// A - Source: filled, Target: filled
// B - Source: row, Target: columnar
func TestEqualizeFilledRowSourceFilledColumnarTarget(t *testing.T) {
	sourcePayload := `[
		{ "id": 1, "name": "Alice", "updated_at": "2020-01-01" },
		{ "id": 2, "name": "Bob", "updated_at": "2020-01-03" },
		{ "id": 3, "name": "Charlie", "updated_at": "2020-01-03" }
...
// A - Source: filled, Target: filled
// B - Source: columnar, Target: row
func TestEqualizeFilledColumnarSourceFilledRowTarget(t *testing.T) {
	sourcePayload := `{
		"id": [1, 2, 3],
		"name": ["Alice", "Bob", "Charlie"],
		"updated_at": ["2020-01-01", "2020-01-03", "2020-01-03"]
